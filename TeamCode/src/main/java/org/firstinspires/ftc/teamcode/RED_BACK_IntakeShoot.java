...
@Autonomous(name = "RED_BACK_IntakeShoot", group = "Robot")
public class RED_BACK_IntakeShoot extends OpMode {
    // Variables
    ...
    private final Pose closeArtifactStart = new Pose(86.5, 36, Math.toRadians(0));
    private final Pose closeArtifactCollect = new Pose(120, 36, Math.toRadians(0));
