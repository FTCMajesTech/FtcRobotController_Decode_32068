...
@Autonomous(name = "BLUE_TOP_IntakeShootWOOS", group = "Robot")
public class BLUE_TOP_IntakeShootWOOS extends OpMode {
    // Variables
    ...
    private final Pose closeArtifactCollect = new Pose(15, 84, Math.toRadians(180));
