...
@Autonomous(name = "BLUE_TopZone_IntakeShoot", group = "Robot")
public class BLUE_TopZone_IntakeShoot extends OpMode {
    ...
    private final Pose shootingSpot = new Pose(60, 84, Math.toRadians(135));
    private final Pose closeArtifactStart = new Pose(57.5, 84, Math.toRadians(0));
    private final Pose closeArtifactCollect = new Pose(20, 84, Math.toRadians(0));
    private final Pose middleArtifactStart = new Pose(57.5, 60, Math.toRadians(0));
    private final Pose middleArtifactCollect = new Pose(20, 60, Math.toRadians(0));
    private final Pose endPose = new Pose(57.5, 60, Math.toRadians(0));
    // PathChains
